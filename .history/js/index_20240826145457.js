...
document.addEventListener('DOMContentLoaded', function() {
    ...
    formulario.addEventListener('submit', function(event) {
        ...
        if (nomeValor.length < 3) {
            ...
            nomeMensagem.style.display = 'block';
            return;
        } else {
            nomeMensagem.textContent = '';
            nomeMensagem.style.display = 'none';
        }
        ...
        if (!isValidEmail(emailValor)) {
            emailMensagem.textContent = 'Por favor, insira um e-mail válido.';
            emailMensagem.style.display = 'block';
            return;
        } else {
            emailMensagem.textContent = '';
            emailMensagem.style.display = 'none';
        }
